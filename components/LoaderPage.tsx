    ...
    <>
      <style jsx>{`
        ...
        .loaderbook-container {
          ...
          min-height: 100vh;
          width: 100%;
          background: linear-gradient(135deg, #d1ffe1 0%, #d1ffe1 100%);
        }
      `}</style>
      ...
      <div className="loaderbook-container">
        <div className="loaderbook md:scale-160">
          ...
          <span className="animate-pulse font-semibold bg-green-100 p-2 rounded-lg">กำลังโหลดข้อมูลเอกสาร</span>
        </div>
      </div>
    </>
  );
